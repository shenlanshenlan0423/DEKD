...
from src.model.Clustering import run_clustering
...
class DEKD:
    ...
    def fit(self, X_train, y_train, X_val, y_val):
        ...
        self.DE(X_train, y_train)
        self.y_proba_by_teacher = self.teacher_predict_proba(X_train)
        self.KD(X_train, y_train, X_val, y_val)

    def DE(self, X_train, y_train):
    ...
    def teacher_predict_proba(self, X):
        ...
        weight = compute_weight(distances, self.args.Alpha)
    ...
    def binary_cross_entropy(self, pred, dtrain):
        T, Lambda = self.args.Beta, self.args.Lambda
        ...
        grad = (1 - Lambda) * soft_grad + Lambda * hard_grad
        hess = (1 - Lambda) * soft_hess + Lambda * hard_hess

        return grad, hess

    def KD(self, X_train, y_train, X_val, y_val):
        params = {
            'silent': 1,
